...
.. note:: Confirm before installing, that your Grafana and Prometheus versions are supported by the Scylla Monitoring Stack version you want to install. See the :ref:`Scylla Monitoring Stack Compatibility Matrix <Scylla_Monitoring_Stack_Compatibility_Matrix>`.
